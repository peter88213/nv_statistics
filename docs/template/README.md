...
Download the latest release [nv_statistics_v0.99.0.pyzw](https://github.com/peter88213/nv_statistics/raw/main/dist/nv_statistics_v0.99.0.pyzw)

- Launch *nv_statistics_v0.99.0.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_statistics_v0.99.0.pyzw` (Windows), resp. `python3 nv_statistics_v0.99.0.pyzw` (Linux) on the command line.
