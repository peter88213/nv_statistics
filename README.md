[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_statistics/raw/main/dist/nv_statistics_v5.4.2.pyzw)
...
Download the latest release [nv_statistics_v5.4.2.pyzw](https://github.com/peter88213/nv_statistics/raw/main/dist/nv_statistics_v5.4.2.pyzw)

- Launch *nv_statistics_v5.4.2.pyzw* by double-clicking (Windows/Linux desktop),
- or execute `python nv_statistics_v5.4.2.pyzw` (Windows), resp. `python3 nv_statistics_v5.4.2.pyzw` (Linux) on the command line.
