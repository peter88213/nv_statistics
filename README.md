[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_statistics/raw/main/dist/nv_statistics_v5.8.4.pyz)
...
Download the latest release [nv_statistics_v5.8.4.pyz](https://github.com/peter88213/nv_statistics/raw/main/dist/nv_statistics_v5.8.4.pyz) (24 KB)

- Launch *nv_statistics_v5.8.4.pyz* by double-clicking (Windows desktop),
- or execute `python nv_statistics_v5.8.4.pyz` (Windows), resp. `python3 nv_statistics_v5.8.4.pyz` (Linux) on the command line.
...
The package is also available in zip format: [nv_statistics_v5.8.4.zip](https://github.com/peter88213/nv_statistics/raw/main/dist/nv_statistics_v5.8.4.zip) (24 KB)

- Extract the *nv_statistics_v5.8.4* folder from the downloaded zipfile "nv_statistics_v5.8.4.zip".
